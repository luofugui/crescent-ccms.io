...
[[categories]]
  ...
  [[categories.musicians]]
    ...
    photo = "sunnie-ling.jpg"
    bio = "Sunnie Ling is a guzheng performer and educator specializing in traditional and contemporary Chinese music. She holds a Master of Arts in Chinese Music and Culture from Bard College Conservatory of Music, where she focused on guzheng performance and cross-cultural collaboration.\n\nShe began studying guzheng at the age of 10 and later trained under Professor Zhou Wang of the China Central Conservatory of Music, a second-generation inheritor of the Shaanxi zheng school and a leading figure in the field of guzheng performance.\n\nWith over a decade of performance experience, Sunnie has appeared on major stages including Carnegie Hall, and has participated in numerous concerts, festivals, and cultural exchange events across the United States and China. Her playing blends technical precision with expressive sensitivity, reflecting both classical foundations and a passion for musical storytelling.\n\nAs an advocate for Chinese traditional music, she actively shares guzheng through solo and ensemble performances, community outreach, and educational programs. Her mission is to bridge cultures through music and to bring the voice of the guzheng to a broader global audience."
  [[categories.musicians]]
    name = "Sunny Shang"
    instrument = "琵琶 (Pipa)"
...
[[categories]]
  ...
  musicians = [] # Empty for now, can be added later
+++
